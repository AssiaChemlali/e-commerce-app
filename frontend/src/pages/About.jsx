  ...
  return (
    <div className='border-t py-10 text-center m-auto w-full '>
      ...
      <div className='flex flex-col items-center md:flex-row gap-10 mt-10'>
        <img src={assets.about_img} alt="" className='object-cover w-full h-full md:w-[480px]' />
        <div className="w-full  text-base text-gray-600 flex gap-4 flex-col text-left">
